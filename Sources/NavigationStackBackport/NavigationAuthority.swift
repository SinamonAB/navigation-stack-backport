...
class NavigationAuthority: NSObject, ObservableObject {
    private var showingSwiftUI: Bool = false
...
extension NavigationAuthority: UINavigationControllerDelegate {
    func navigationController(_ navigationController: UINavigationController, didShow viewController: UIViewController, animated: Bool) {
        ...
        let isSwiftUIViewController = viewController is UIHostingController<AnyView>
        
        defer {
            viewControllersCount = count
            showingSwiftUI = isSwiftUIViewController
        }
        
        guard count < viewControllersCount else {
            return
        }
